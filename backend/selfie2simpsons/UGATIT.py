...
# writer = SummaryWriter('./results/people2simpson/log')
...
class UGATIT(object) :
    ...
    def train(self):
        ...
        for step in range(start_iter, self.iteration + 1):
            ...
            G_loss_A =  self.adv_weight * (G_ad_loss_GA + G_ad_cam_loss_GA + G_ad_loss_LA + G_ad_cam_loss_LA) + self.identity_weight * G_recon_loss_A + self.identity_weight * G_identity_loss_A + self.cam_weight * G_cam_loss_A
            ...
            print(message)
            log_name = os.path.join(self.result_dir, self.dataset, 'loss_log.txt')
            with open(log_name, "a") as log_file:
                log_file.write('%s\n' % message)  # save the message
            
#             writer.add_scalar('loss_content', Discriminator_loss.item(), step + 1)
#             writer.add_scalar('loss_style', Generator_loss.item(), step + 1)
